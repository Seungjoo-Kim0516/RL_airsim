...
state_save_path = 'D:/KSJ/Workspace/EightFigure_20240222/Flight_Data/NewStateData_1/'
rotor_save_path = 'D:/KSJ/Workspace/EightFigure_20240222/Flight_Data/NewRotorData_1/'
...
def train():
    ...
    action_std_decay_rate = 0.0005       # linearly decay action_std (action_std = action_std - action_std_decay_rate)
    ...
    model_to_be_continued = 'D:/KSJ/Workspace/EightFigure_20240222/models/DRL/'
    if continue_training:
        print("Bringing model :  PPO_DRL_47_37_16_-573.0038203902933_best")
        # print("Bringing model : " + checkpoint_path)
        ppo_agent.load(model_to_be_continued + "PPO_DRL_47_37_16_-573.0038203902933_best.pth")
        ...
        for t in range(1, max_ep_len+1):
            ...
            if done or t == max_ep_len:
                ...
                if current_ep_reward > best_reward:
                    best_model_path = directory + "PPO_{}_{}_{}_{}_{}_best.pth".format(env_name, random_seed, run_num_pretrained, i_episode, current_ep_reward)
